...
public class PdfCreater {
    ...
    public void writeSimplePdf() throws Exception {
        ...
        Font font = FontFactory.getFont(FontFactory.COURIER, 14F, Font.BOLD, new BaseColor(255, 150, 200));
    ...
    public void writeCharpter() throws Exception {
        ...
        document.add(new Paragraph("First page of the document."));
        document.add(new Paragraph("First page of the document."));
        document.add(new Paragraph("Some more text on the first page with different BaseColor and font type.",
