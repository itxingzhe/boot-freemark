package cn.wyb.personal.pdf.util;
...
import cn.wyb.personal.pdf.component.PDFKit;
import cn.wyb.personal.pdf.exception.FreeMarkerException;
import cn.wyb.personal.pdf.exception.PDFException;
...
public class FreeMarkerUtil {
    ...
    private static Map<String, FileTemplateLoader> fileTemplateLoaderCache = Maps.newConcurrentHashMap();

    private static Map<String, Configuration>      configurationCache      = Maps.newConcurrentHashMap();
    ...
    public static String getPDFTemplatePath(String fileName) {
        ...
        String templatePath = classpath + "/static/ftl";
        ...
        for (File f : file.listFiles()) {
            ...
            if (templateName.lastIndexOf(".html") == -1) {
                continue;
            }
